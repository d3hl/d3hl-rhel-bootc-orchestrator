...
- Live bootc `.4` build + push (`PUBLISH-001`): added `zsh`, `git`, `ceph-common` to the baked set, enabling `rhceph-9-tools-for-rhel-10` for ceph-common; pushed `quay.io/ncdv/rhel10-base:rhel10-bootc-20260617.4`. One probe register/unregister cycle to discover the ceph repo.
